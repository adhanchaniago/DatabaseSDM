...
<div id="myTabContent" class="tab-content">
 ...
 <br>
<a href="./page/riwayat peserta/printexcel.php" class="btn btn-default pull-right" style="background: #8b0000; color: #fff; margin-right:20px; margin-bottom: 10px" target="blank">ExploreToExcel</a>
<a href="word.php?ID=<?=$data->ID; ?>" class="btn btn-default pull-right" style="background: #8b0000; color: #fff; margin-right:20px; margin-bottom: 10px" target="blank">Word</a>
<br>
<br> 
      <div class="row">
                <div class="col-md-12">
